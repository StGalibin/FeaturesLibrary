...
Процедура ПравоДоступаУстановлено() Экспорт
	...
	Если не Контекст.ЕстьПраво Тогда
		ВызватьИсключение "На " + КонтекстСохраняемый.ИсследуемыйОбъектМетаданныхСтрокой + " нет прав доступа!";
	КонецЕсли;
...
Процедура ПраваДоступаНаОбъектНет() Экспорт
	...
	Если Контекст.ЕстьПраво Тогда
		ВызватьИсключение "На " + КонтекстСохраняемый.ИсследуемыйОбъектМетаданныхСтрокой + " есть право доступа!";
		КонецЕсли;
